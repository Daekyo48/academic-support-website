...
export default function WebPage() {
  ...
  const calculateRawScore = useCallback(() => {
    ...
    if (!subject) {
      setErrors((prev) => ({
        ...prev,
        performance: { 1: "과목을 찾을 수 없습니다", 2: "", 3: "" },
        written: { 1: "", 2: "" },
      }))
      setRawScoreMessage(null)
      return
    ...
    subject.performanceAssessments.forEach((assessment, index) => {
      const score = Number.parseFloat(inputs[`performance${index + 1}` as keyof typeof inputs])
            ...
            <div className="space-y-4">
              <div className="border border-black rounded-lg p-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500 whitespace-nowrapoverflow-hidden text-ellipsis">
